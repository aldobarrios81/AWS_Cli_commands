#!/bin/bash
# setup-console-auth-failures-monitoring.sh
# Create log metric filter and alarm for console authentication failures
...
if [ $# -eq 0 ]; then
    ...
    echo "Email es opcional, por defecto: security-alerts@company.com"
    exit 1
fi
...
ALARM_NAME="CIS-3.6-ConsoleAuthFailures"
SNS_TOPIC_NAME="cis-security-alerts-${PROFILE}"
ALARM_DESCRIPTION="CIS 3.6 - Console authentication failures detected for ${PROFILE}"
NOTIFICATION_EMAIL="${2:-felipe.castillo@azlogica.com}"

# Patrón del filtro para detectar fallos de autenticación en consola
...
echo "=================================================================="
echo -e "${BLUE}🔒 IMPLEMENTANDO CIS 3.6 - CONSOLE AUTH FAILURES MONITORING${NC}"
echo "=================================================================="
echo "Perfil: $PROFILE | Región: $REGION"
echo "Regla: Create log metric filter and alarm for console authentication failures"
echo ""
...
# Resumen final
echo "=================================================================="
echo -e "${GREEN}🎉 IMPLEMENTACIÓN CIS 3.6 COMPLETADA${NC}"
echo "=================================================================="
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "✅ Metric Filters para detectar fallos de autenticación en consola"
echo "✅ CloudWatch Alarms que se activan ante intentos de acceso fallidos"
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "• Detecta intentos de acceso no autorizado a la consola AWS"
echo "• Identifica posibles ataques de fuerza bruta"
echo "• Permite respuesta rápida ante actividad sospechosa"
echo "• Ayuda a identificar credenciales comprometidas"
echo "• Cumple con requisitos de seguridad y auditoría"
echo ""
...
echo "   ./verify-console-auth-failures-monitoring.sh"
echo ""
echo "3. Probar las notificaciones (opcional):"
echo "   aws sns publish --topic-arn $SNS_TOPIC_ARN --message 'Prueba de notificación CIS 3.6' --profile $PROFILE"
echo ""
echo "4. Establecer procedimientos de respuesta para fallos de autenticación:"
echo "   - Investigar inmediatamente múltiples fallos de un IP"
echo "   - Revisar logs de acceso y actividad sospechosa"
echo "   - Considerar bloqueo temporal de IPs maliciosas"
echo ""
echo "5. Monitorear regularmente las alertas y patrones de ataque"
echo ""
echo "6. Documentar esta configuración en la política de seguridad"
echo ""