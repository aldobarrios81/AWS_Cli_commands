#!/bin/bash
# setup-nacl-changes-alarm.sh
# Establece un Log Metric Filter y alarma para cambios en Network ACLs
...
aws logs put-metric-filter \
    ...
    --filter-pattern '{($.eventSource = "ec2.amazonaws.com") && ($.eventName = "CreateNetworkAcl" || $.eventName = "DeleteNetworkAcl" || $.eventName = "ReplaceNetworkAclEntry" || $.eventName = "ReplaceNetworkAclAssociation" || $.eventName = "CreateNetworkAclEntry" || $.eventName = "DeleteNetworkAclEntry")}'
