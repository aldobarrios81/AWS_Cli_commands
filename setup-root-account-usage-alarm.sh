#!/bin/bash
# setup-root-account-usage-alarm.sh

PROFILE="xxxxxxx"
REGION="us-east-1"
SNS_TOPIC_ARN="arn:aws:sns:us-east-1:xxxxxxxx:securityhub-alerts" # Cambia si quieres otro SNS
...
echo "=== Configurando Metric Filter y Alarma para uso de Root Account en $REGION ==="
...
echo "=== Metric Filter y Alarmas configuradas para uso de Root Account ✅ ==="
