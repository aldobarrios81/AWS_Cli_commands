...
# Generado para perfil: azbeacons

PROFILE="azbeacons"
REGION="us-east-1"
SNS_TOPIC_ARN="arn:aws:sns:us-east-1:742385231361:cloudformation-stack-notifications"
...
FAILED_STACKS=(prod-IOT-StackIOT neo-ecommerce prod-icon-my-stack prod-azbeacons-my-stack)
