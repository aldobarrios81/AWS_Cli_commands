#!/bin/bash
# setup-iam-policy-changes-monitoring.sh
# Create log metric filter and alarm for IAM policy changes
# Regla de seguridad CIS AWS: 3.4 - Monitor IAM policy changes
...
FILTER_NAME="CIS-IAMPolicyChanges"
...
# Patrón del filtro para detectar cambios en políticas IAM
FILTER_PATTERN='{ ($.eventName = "CreatePolicy") || ($.eventName = "DeletePolicy") || ($.eventName = "CreatePolicyVersion") || ($.eventName = "DeletePolicyVersion") || ($.eventName = "AttachUserPolicy") || ($.eventName = "DetachUserPolicy") || ($.eventName = "AttachGroupPolicy") || ($.eventName = "DetachGroupPolicy") || ($.eventName = "AttachRolePolicy") || ($.eventName = "DetachRolePolicy") }'
...
echo "=================================================================="
echo -e "${BLUE}🔒 IMPLEMENTANDO CIS 3.4 - IAM POLICY CHANGES MONITORING${NC}"
echo "=================================================================="
echo "Perfil: $PROFILE | Región: $REGION"
echo "Regla: Create log metric filter and alarm for IAM policy changes"
echo ""
...
# Resumen final
echo "=================================================================="
echo -e "${GREEN}🎉 IMPLEMENTACIÓN CIS 3.4 COMPLETADA${NC}"
echo "=================================================================="
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "✅ Metric Filters para detectar cambios en políticas IAM en CloudTrail"
echo "✅ CloudWatch Alarms que se activan cuando se detectan cambios IAM"
echo "✅ SNS Topic para notificaciones de seguridad"
echo "✅ Cumplimiento con CIS AWS Benchmark 3.4"
echo ""
echo -e "${BLUE}🔍 EVENTOS IAM MONITOREADOS:${NC}"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "• CreatePolicy - Crear nueva política IAM"
echo "• DeletePolicy - Eliminar política IAM"
echo "• CreatePolicyVersion - Crear nueva versión de política"
echo "• DeletePolicyVersion - Eliminar versión de política"
echo "• AttachUserPolicy - Adjuntar política a usuario"
echo "• DetachUserPolicy - Remover política de usuario"
echo "• AttachGroupPolicy - Adjuntar política a grupo"
echo "• DetachGroupPolicy - Remover política de grupo"
echo "• AttachRolePolicy - Adjuntar política a rol"
echo "• DetachRolePolicy - Remover política de rol"
echo ""
echo -e "${YELLOW}⚠️ IMPORTANCIA DE ESTA REGLA:${NC}"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "• Las políticas IAM controlan el acceso a recursos AWS"
echo "• Cambios no autorizados pueden crear vulnerabilidades de seguridad"
echo "• Detección temprana ayuda a prevenir escalación de privilegios"
echo "• Cumple con mejores prácticas de seguridad y auditoría"
echo ""
...
echo "   ./verify-iam-policy-changes-monitoring.sh"
echo ""
echo "3. Probar las notificaciones (opcional):"
echo "   aws sns publish --topic-arn $SNS_TOPIC_ARN --message 'Prueba de notificación CIS 3.4' --profile $PROFILE"
echo ""
echo "4. Revisar regularmente las alertas y investigar cambios no planificados"
echo ""
