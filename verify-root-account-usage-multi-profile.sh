#!/bin/bash
# verify-root-account-usage-multi-profile.sh
# Verificar el estado de la implementación de CIS 3.3 - Root Account Usage Monitoring
# Para múltiples perfiles AWS

# Configuración de perfiles
PROFILES=("metrokia" "azlogica")
REGION="us-east-1"
...
# Función para verificar un perfil específico
verify_profile() {
    local PROFILE=$1
    ...
    if [ $? -ne 0 ] || [ -z "$ACCOUNT_ID" ]; then
        ...
        echo -e "${YELLOW}   Saltando al siguiente perfil...${NC}"
        echo ""
        return 1
    fi
    ...
    echo "=================================================================="
    echo -e "${GREEN}🎯 VERIFICACIÓN COMPLETADA PARA $PROFILE${NC}"
    echo "=================================================================="
    echo ""
}
...
main() {
    echo ""
    echo "░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░"
    echo -e "${CYAN}🔐 VERIFICACIÓN DE USO DE CUENTA ROOT - MÚLTIPLES PERFILES${NC}"
    echo "░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░"
    echo -e "${BLUE}Perfiles a verificar: ${PROFILES[*]}${NC}"
    echo -e "${BLUE}Región: $REGION${NC}"
    echo -e "${BLUE}Fecha/Hora: $(date)${NC}"
    echo ""
    ...
    echo "██████████████████████████████████████████████████████████████████"
    echo -e "${GREEN}✅ Perfiles verificados exitosamente: $SUCCESSFUL_PROFILES${NC}"
    echo -e "${RED}❌ Perfiles con errores: $FAILED_PROFILES${NC}"
    ...
    echo "   aws sns subscribe --topic-arn [SNS_ARN] --protocol email --notification-endpoint [EMAIL] --profile [PROFILE]"
    echo ""
    echo "2. Monitorear regularmente el estado de las alarmas en ambos perfiles"
    echo ""
    ...
    echo ""
    echo "5. Considerar implementar automatización para remediation inmediata"
    echo ""
}
